...
public class CommentController {
    ...
    public Object getGoodsSkuCommentList(@PathVariable(required = false) Long goodsSkuId, @RequestParam(required = false) Integer page, @RequestParam(required = false) Integer pageSize)
    {
    ...
    public Object auditComment(@PathVariable Long did, @PathVariable Long id, @Depart Long departId,
    ...
    public Object getAllStateComment(@RequestParam(required = false) long shopId,
                                         @RequestParam(required = false) Integer page,
                                         @RequestParam(required = false) Integer pageSize
    ) {
        page = (page == null) ? 1 : page;
        pageSize = (pageSize == null) ? 10 : pageSize;
        ReturnObject<PageInfo<VoObject>> returnObject = commentService.getAllCommentListByShopId(shopId, page, pageSize);
        return ResponseUtil.ok(returnObject.getData());
    }
