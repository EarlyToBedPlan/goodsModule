...
public class GoodsSkuPo {
    ...
    public GoodsSkuPo(GoodsSkuPo goodsSkuPo) {
        this.configuration = goodsSkuPo.configuration;
        this.detail = goodsSkuPo.detail;
        this.disabled = goodsSkuPo.disabled;
        this.gmtCreated = goodsSkuPo.gmtCreated;
        this.gmtModified = goodsSkuPo.gmtModified;
        this.goodsSpuId = goodsSkuPo.goodsSpuId;
        this.id = goodsSkuPo.id;
        this.imageUrl = goodsSkuPo.imageUrl;
        this.inventory = goodsSkuPo.inventory;
        this.name = goodsSkuPo.name;
        this.originalPrice = goodsSkuPo.originalPrice;
        this.skuSn = goodsSkuPo.skuSn;
        this.weight = goodsSkuPo.weight;
    }
}